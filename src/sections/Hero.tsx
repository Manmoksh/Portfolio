    ...
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      ...
      <div className="container relative z-10">
        <div className="flex flex-col items-center">
          <Image src={memojiImage} alt="nerd, me" className="size-[100px]" />
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          <a
            href="/Manmoksh_Resume.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="min-w-[180px] justify-center inline-flex items-center gap-2 px-6 h-12 rounded-xl border border-white/15 text-white hover:bg-white/15 transition"
          >
